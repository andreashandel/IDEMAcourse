...
**The geeky way:** Create a personal website, e.g., by using [this workflow](https://www.andreashandel.com/posts/blogdown-website-1/). Or use any other setup you want to use. 
