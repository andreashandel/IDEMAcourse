...
You should see a short message on the screen. Some packages show messages when you load them, and others don't. In this case, the package tells you that you can start using it by typing `dsaidemenu()` into the R console. You can do that now, or go straight to the next reading, which will talk about DSAIDE in more detail.
