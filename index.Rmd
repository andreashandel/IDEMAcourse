...
**Unfortunately, the latest version of the DSAIDE package didn't make it on CRAN in time (they are on vacation). Therefore, you need to install it using Github. Make sure you have version 0.8.6.**
