...
To distinguish between resources that are used in the course, and others that are related but not directly used, I decided to have two resource pages. The _Course Resources_ page lists materials we'll be (partially) using in the course. This page lists a lot of other resources that might not be used or mentioned explicitly in the course, but that might be useful and interesting. Everything listed here is of course related to the course topic, i.e. infectious disease epidemiology (and related areas, e.g. ecology/evolution), with a focus on a model-based perspective. For even more materials, see the links to various lists by others at the end of this document.
