...
You will be asked regularly to post discussions to Slack, and respond to posts by others. **Those often have Wednesday deadlines.** I also encourage general, continued participation on the discussion boards. Participation can take any form, such as asking questions, answering questions, posting links to interesting content, providing feedback, etc. The more, the better `r emo::ji('smile')`. Both quality and quantity will affect your participation grade. More details are given in either the _Exercises_ or _Assessment_ document for each module.
