...
## Online quizzes
* For each module, there will be (usually two) fairly short quizzes. The primary purpose of the quizzes is to ensure you worked through the assigned material.
...
* The quizzes are available in the _Course Resources_ section. There you will find links to quiz sheets in the form of Excel files. Each Excel file contains quiz questions covering either the DSAIDE software or the other course material (or both). You can fill in the answers on the quiz sheet at any time, and once finished, you need to upload it [to this website](https://shiny.ovpr.uga.edu/gradingapp/) by the due date for a given week. **You can only submit your answers once for each quiz, and you will not be able to submit your quiz after the due date.** 


## Exercises
Most course modules have one or more exercises, which are due on the last day of the module. These exercises are listed in the _Exercises_ section. I will likely add further ones, so look out for updates. The _Assessment_ document for each module will tell you which exercise to do.
