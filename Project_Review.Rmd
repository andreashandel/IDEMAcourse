...
* Review the whole project using the review template. You can get and use the template either [as an RMarkdown document](./media/Project_Review_Template.Rmd) or a [Word document](./media/Project_Review_Template.docx). Write a detailed review using and filling the review template. Provide your review to the project team and myself (either through Slack or email).
